...
func wwwIndexHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "www/index.html", size: 1849, mode: os.FileMode(420), modTime: time.Unix(1502226936, 0)}
